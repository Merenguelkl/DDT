...
parser.add_argument('--weights', default='/home/videt/lkl/Restormer/experiments/031_RealDenoising_DeformableV2/models/net_g_116000.pth', type=str, help='Path to weights')

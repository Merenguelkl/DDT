...
from basicsr.models.archs.deformableV2_arch import deformableV2
...
parser.add_argument('--input_dir', default='/home/videt/lkl/datasets/CVPR23W/val/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/Gaussian_Color_Denoising/', type=str, help='Directory for results')
parser.add_argument('--weights', default='/home/videt/lkl/Restormer/experiments/201_GaussianColorDenoising_DDT_Sigma50_CVPR23W/models/net_g_288000.pth', type=str, help='Path to weights')
...
datasets = ['CBSD68', 'Kodak', 'McMaster']
# datasets = ['Kodak']
# datasets = ['Urban100']
for sigma_test in sigmas:
    print("Compute results for noise level",sigma_test)
    model_restoration = deformableV2(**x['network_g'])
    # if args.model_type == 'blind':
